...
module.exports = {
    input: {
        alias: "i",
        name: translate("commands.zoomout.args.input.name"),
        desc: translate("commands.zoomout.args.input.desc"),
        type: "file",
        required: true,
        settings: {
            allowed: {
    ...
    multiplier: {
        alias: "m",
        name: translate("commands.zoomout.args.multiplier.name"),
        desc: translate("commands.zoomout.args.multiplier.desc"),
        type: "number",
        required: false,
        settings: {
            dft: 2,
    ...
    direction: {
        alias: "d",
        name: translate("commands.zoomout.args.direction.name"),
        desc: translate("commands.zoomout.args.direction.desc"),
        type: "string",
        required: false,
        settings: {
            allowed: {
    ...
    originY: {
        alias: "oy",
        name: translate("commands.zoomout.args.originY.name"),
        desc: translate("commands.zoomout.args.originY.desc"),
        type: "string",
        required: false,
        settings: {
            allowed: {
    ...
    originX: {
        alias: "ox",
        name: translate("commands.zoomout.args.originX.name"),
        desc: translate("commands.zoomout.args.originX.desc"),
        type: "string",
        required: false,
        settings: {
            allowed: {
    ...
    scaleAlgorithm: {
        alias: "s",
        name: translate("commands.zoomout.args.scaleAlgorithm.name"),
        desc: translate("commands.zoomout.args.scaleAlgorithm.desc"),
        type: "string",
        required: false,
        settings: {
            allowed: {
