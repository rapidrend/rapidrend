...
module.exports = {
    input: {
        alias: "i",
        name: translate("commands.enlarge.args.input.name"),
        desc: translate("commands.enlarge.args.input.desc"),
        type: "file",
        required: true,
        settings: {
            allowed: {
    ...
    multiplier: {
        alias: "m",
        name: translate("commands.enlarge.args.multiplier.name"),
        desc: translate("commands.enlarge.args.multiplier.desc"),
        type: "number",
        required: false,
        settings: {
            dft: 2,
    ...
    direction: {
        alias: "d",
        name: translate("commands.enlarge.args.direction.name"),
        desc: translate("commands.enlarge.args.direction.desc"),
        type: "string",
        required: false,
        settings: {
            allowed: {
    ...
    scaleAlgorithm: {
        alias: "s",
        name: translate("commands.enlarge.args.scaleAlgorithm.name"),
        desc: translate("commands.enlarge.args.scaleAlgorithm.desc"),
        type: "string",
        required: false,
        settings: {
            allowed: {
