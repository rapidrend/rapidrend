...
module.exports = {
    name: translate("commands.contract.name"),
    description: translate("commands.contract.description"),
    category: translate("categories.resizing"),
    args: require("#args/commands/resizing/contract"),
    globalArgs: ["encodingPreset"],
    execute: async function (args) {
        const file = args.input;
        const { multiplier, direction, originX, originY } = args;
