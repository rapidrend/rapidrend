...
module.exports = {
    name: translate("commands.tenorcaption.name"),
    description: translate("commands.tenorcaption.description"),
    category: translate("categories.captions"),
    args: require("#args/commands/captions/tenorcaption"),
    ...
    execute: async function (args) {
        ...
        const strokeWidth = borderSize == 0 ? 0 : Math.max(Math.round(fontSize * 0.02) * borderSize, 1);
