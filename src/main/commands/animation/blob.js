...
module.exports = {
    ...
    execute: async function (args) {
        ...
        const { path, shortType, width, height, fps } = file;
        ...
        switch (shortType) {
            ...
            case "video":
                ...
                await execPromise(`ffmpeg -r ${fps.includes("0/0") ? "50" : fps} -i "${path}" \
                    -r ${fps.includes("0/0") ? "50" : fps} -i assets/image/transparent.png \
                    -filter_complex "[1:v][0:v]scale2ref=w=iw+iw/10:h=ih[transparent][overlay];\
